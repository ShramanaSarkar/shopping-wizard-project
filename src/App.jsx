  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/add-product" element={<AddProduct theme={theme} countProduct={countProduct} setCountProduct={setCountProduct} addProduct={addProduct} productType={productType} category={category} subcategory={subcategory} />} />
